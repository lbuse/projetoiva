...
VaccinationModel _$VaccinationModelFromJson(Map<String, dynamic> json) {
  return VaccinationModel(
    ...
    estabelecimentoRazaoSocial: json['estabelecimento_razaoSocial'] as String,
    ...
    vacinaGrupoAtendimentoNome: json['vacina_grupoAtendimento_nome'] as String,
    ...
    vacinaFabricanteReferencia: json['vacina_fabricante_referencia'] as String,
